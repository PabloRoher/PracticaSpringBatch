...
public class CuentaResource {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CuentaDTO> getCuenta(@PathVariable(name = "id") final Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Long> updateCuenta(@PathVariable(name = "id") final Long id,
    ...
    public ResponseEntity<Void> deleteCuenta(@PathVariable(name = "id") final Long id) {
